                ...
                <div className="mt-7 grid grid-cols-1 gap-4 sm:grid-cols-2">
                    {puntos.map((p, i) => (
                        <motion.div
                            ...
                            className="group rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-6 transition-all hover:border-zinc-300 dark:hover:border-zinc-700 hover:shadow-xl hover:shadow-zinc-900/5"
                        >
                            <div
