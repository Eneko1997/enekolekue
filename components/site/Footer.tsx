...
const COLS = [
    {
        title: "OPE 2026",
        links: [
            { label: "Auxiliares Administrativos", href: "/dashboard" },
            { label: "Administrativos", href: "/dashboard" },
            { label: "Técnicos de Gestión", href: "/dashboard" },
            { label: "Técnicos Superiores", href: "/dashboard" },
        ],
    },
    {
        title: "Recursos",
