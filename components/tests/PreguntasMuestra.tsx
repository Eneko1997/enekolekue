import MuestraCTA from "@/components/tests/MuestraCTA"
    ...
    return (
        <section id="muestra" className="scroll-mt-20 px-5 py-8">
            <div className="mx-auto max-w-4xl">
                ...
                {/* CTA: muro de registro (invitado) o "elige un test" (registrado) */}
                <MuestraCTA link={link} restantes={restantes} tituloNorma={tituloNorma} />
