...
const ACCENT = "#10B981"
const PATH = "/simulacro-tecnico-gestion-gobierno-vasco"

export const metadata: Metadata = {
    title: "Simulacro Técnico de Gestión del Gobierno Vasco — gratis | Gainditu",
    description:
        "Haz gratis un simulacro tipo examen de Técnico de Gestión del Gobierno Vasco: 60 preguntas con penalización. Corrección al momento con tu nota y desglose por áreas. Sin registro para empezar.",
...
const PUNTOS = [
    {
        ...
        d: "Preguntas del temario de Técnico de Gestión con penalización por error, como en la OPE.",
    },
    {
        t: "Unos 60 minutos",
...
const AREAS_MOCK = [
    { l: "Constitución y derechos", p: 76 },
    { l: "Régimen jurídico y organización", p: 63 },
    { l: "Empleo público", p: 48 },
    { l: "Institucional vasco y UE", p: 71 },
]
                ...
                <div className="mx-auto grid max-w-5xl items-center gap-10 lg:grid-cols-2 lg:gap-12">
                    <div>
                        ...
                        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-zinc-950 dark:text-zinc-50 sm:text-5xl">
                            Simulacro Técnico de Gestión del Gobierno Vasco
                        </h1>
                        <p className="mt-4 max-w-md text-lg text-zinc-600 dark:text-zinc-300">
                            Ponte a prueba con un examen real: 60 preguntas del temario de Técnico de
                            Gestión, con penalización, y corrección al momento con tu nota y tus puntos débiles.
                        </p>
                        <div className="mt-8">
                            <FunnelLandingCTA accent={ACCENT} testId="free_sim_ges" />
                        </div>
                    </div>
                        ...
                        <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-7 shadow-xl shadow-zinc-900/5 dark:border-zinc-800 dark:bg-zinc-900">
                            <div>
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-6xl font-black leading-none" style={{ color: ACCENT }}>6,9</div>
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "Quiz",
                        name: "Simulacro Técnico de Gestión del Gobierno Vasco",
                        about: "Oposición de Técnico de Gestión del Gobierno Vasco",
