...
const ACCENT = "#10B981"
const PATH = "/simulacro-tecnico-superior-gobierno-vasco"

export const metadata: Metadata = {
    title: "Simulacro Técnico Superior del Gobierno Vasco — gratis | Gainditu",
    description:
        "Haz gratis un simulacro tipo examen de la Escala Superior de Administración del Gobierno Vasco (grupo A): 60 preguntas con penalización. Corrección al momento con tu nota y desglose por áreas. Sin registro para empezar.",
    alternates: { canonical: PATH },
}

const PUNTOS = [
    {
        t: "60 preguntas, tipo examen real",
        d: "Preguntas del temario de Técnico Superior con penalización por error, como en la OPE.",
    },
    {
        t: "Unos 60 minutos",
...
const AREAS_MOCK = [
    { l: "Constitución y derechos", p: 79 },
    { l: "Procedimiento avanzado", p: 62 },
    { l: "Régimen jurídico del sector público", p: 55 },
    { l: "Institucional vasco y UE", p: 73 },
]
                ...
                <div className="mx-auto grid max-w-5xl items-center gap-10 lg:grid-cols-2 lg:gap-12">
                    <div>
                        ...
                        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-zinc-950 dark:text-zinc-50 sm:text-5xl">
                            Simulacro Técnico Superior del Gobierno Vasco
                        </h1>
                        <p className="mt-4 max-w-md text-lg text-zinc-600 dark:text-zinc-300">
                            El nivel más alto del cuerpo general (grupo A). Ponte a prueba con 60 preguntas
                            del temario, con penalización y corrección al momento con tus puntos débiles.
                        </p>
                        <div className="mt-8">
                            <FunnelLandingCTA accent={ACCENT} testId="free_sim_sup" />
                        </div>
                    </div>
                        ...
                        <div className="relative overflow-hidden rounded-3xl border border-zinc-200 bg-white p-7 shadow-xl shadow-zinc-900/5 dark:border-zinc-800 dark:bg-zinc-900">
                            <div>
                                ...
                                <div className="text-center">
                                    ...
                                    <div className="text-6xl font-black leading-none" style={{ color: ACCENT }}>6,8</div>
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "Quiz",
                        name: "Simulacro Técnico Superior del Gobierno Vasco",
                        about: "Oposición de Técnico Superior del Gobierno Vasco",
