...
import CalculadoraNotaCorte from "@/components/herramientas/CalculadoraNotaCorte"
import { getHerramienta } from "@/lib/data/herramientas"
import { SITE_URL } from "@/lib/site"

const ACCENT = "#10B981"
const H = getHerramienta("calculadora-nota-corte")!
    ...
    return (
        <main className="flex flex-1 flex-col">
            ...
            <section className="px-5 pb-10">
                <div className="mx-auto max-w-3xl">
                    <CalculadoraNotaCorte />
                </div>
            </section>
            <LeccionCTA
                accent={ACCENT}
                href="/signup"
                titulo="Sube tu nota con tests"
