...
export const metadata: Metadata = {
    title: "Herramientas gratis para oposiciones de Euskadi",
    description:
        "Herramientas gratuitas para opositar en Euskadi: calculadora de nota de corte, ratio aspirantes/plaza, equivalencias de perfil lingüístico y test de qué oposición elegir.",
    keywords: [
    ...
    return (
        <main className="flex flex-1 flex-col">
            <LeccionHero
                ...
                title="Herramientas"
                subtitle="Utilidades gratuitas para opositar en Euskadi: calcula tu nota, mira cómo de competida está tu plaza, convierte tu nivel de euskera y descubre qué oposición encaja contigo."
                accent={ACCENT}
                ctaHref="#lista"
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "ItemList",
                        name: "Herramientas gratis para oposiciones de Euskadi",
