...
import QueOposicion from "@/components/herramientas/QueOposicion"
import { getHerramienta } from "@/lib/data/herramientas"
import { SITE_URL } from "@/lib/site"

const ACCENT = "#10B981"
const H = getHerramienta("que-oposicion-elegir")!
    ...
    return (
        <main className="flex flex-1 flex-col">
            ...
            <LeccionCTA
                accent={ACCENT}
                href="/signup"
                titulo="Empieza a preparar la tuya"
                texto="Cuando tengas clara tu oposición, practica su temario oficial con tests y simulacros. Empieza gratis."
