...
const ACCENT = "#10B981"
const PATH = "/simulacro-auxiliar-administrativo-gobierno-vasco"

export const metadata: Metadata = {
    title: "Simulacro Auxiliar Administrativo del Gobierno Vasco — gratis | Gainditu",
    description:
        "Haz gratis un simulacro tipo examen de Auxiliar Administrativo (C2) del Gobierno Vasco: 30 preguntas con penalización. Corrección al momento con tu nota y desglose por áreas. Sin registro para empezar.",
                ...
                <div className="mx-auto grid max-w-5xl items-center gap-10 lg:grid-cols-2 lg:gap-12">
                    <div>
                        ...
                        <h1 className="mt-4 text-3xl font-extrabold tracking-tight text-zinc-950 dark:text-zinc-50 sm:text-5xl">
                            Simulacro Auxiliar Administrativo del Gobierno Vasco
                        </h1>
                        <p className="mt-4 max-w-md text-lg text-zinc-600 dark:text-zinc-300">
                            La escala más demandada (C2). Ponte a prueba con un examen real: 30 preguntas
                            del temario oficial, con penalización, y corrección al momento con tu nota y
                            tus puntos débiles.
                        </p>
                        <div className="mt-8">
            ...
            <script
                ...
                dangerouslySetInnerHTML={{
                    __html: JSON.stringify({
                        ...
                        "@type": "Quiz",
                        name: "Simulacro Auxiliar Administrativo del Gobierno Vasco",
                        about: "Oposición de Auxiliar Administrativo (C2) del Gobierno Vasco",
